...
libEc2.current = function(argv, context, callback) {
  ...
  return sg.__runll([function(next) {
    ...
    var m;
    var ourVpcs = {}, ourInstances = {}, instancesByPublicIp = {}, instancesByPrivateIp = {}, instancesByFqdn = {};
    ...
    _.each(stacks.byRoute, function(stacks, name) {
      ...
      if (stacks.main)    { route.main = fullInstances ? stacks.main : _.pick(stacks.main, 'route53Name', 'InstanceId', 'PrivateIpAddress'/*, 'Tags', 'LaunchTime'*/); }
      if (stacks.next)    { route.next = fullInstances ? stacks.next : _.pick(stacks.next, 'route53Name', 'InstanceId', 'PrivateIpAddress'/*, 'Tags', 'LaunchTime'*/); }
