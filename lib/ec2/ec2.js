  ...
  return fetch(jsaws.envInfo, g, 'envInfo', argv, context, callback, function() {
    ...
    return sg.__runll([function(next) {
      ...
      sg.each(instancesBy.colorStack, function(stackInstances, stack, ibc) {
        ...
        fullHumanReport.push('---------------------------------------------------------------------------------------------------------------------------------------------');
        fullHumanReport.push('-- stack: '+stack);
        fullHumanReport.push('');
...
var amis = {
  ...
  us_east_1: {
    ...
    trusty  : 'ami-c8580bdf',
//    trusty2 : 'ami-5a6ef94c',   // A custom made ami to speed up the buildout process   23
    trusty2 : 'ami-c6d241d0',   // A custom made ami to speed up the buildout process   24
    xenial  : 'ami-40d28157'
  },
