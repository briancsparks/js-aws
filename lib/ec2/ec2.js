...
libEc2.current = function(argv, context, callback) {
  ...
  return fetch(jsaws.envInfo, g, 'envInfo', argv, context, callback, function() {
    ...
    return sg.__runll([function(next) {
        ...
        return fetch(raRoute53.listResourceRecordSets, g, 'recordSets', params, context, callback, function() {
      ...
      if (iAmProd)     { return next(); }
      if (skipProd)    { return next(); }
      return fetchFrom('10.10.0.251:21234', '/ec2/describeVpcs', g, 'prodVpcs', {}, null, context, callback, next);
    }, function(next) {
      g.prodInstances = {Reservations : []};
      if (iAmProd)     { return next(); }
      if (skipProd)    { return next(); }
      return fetchFrom('10.10.0.251:21234', '/ec2/describeInstances', g, 'prodInstances', {}, null, context, callback, next);
    }], function() {
      ...
      // Find our VPCs
      _.each(g.prodVpcs.Vpcs, function(vpc) {
        g.vpcs[vpc.VpcId] = vpc;
      });
      ...
      sg.eachFrom(g.prodInstances.Reservations, "Instances", function(instance, instanceId) {
        g.instances[instance.InstanceId] = instance;
      });
