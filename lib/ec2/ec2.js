      ...
      _.each(stackInstances, function(colorInstances, color) {
        _.each(colorInstances, function(instance, instanceId) {
          if (instance.Tags.ns.service === 'web') {
            hasMain   = (deref(instance, 'Tags.ns.route') === 'main');
            hasNext   = (deref(instance, 'Tags.ns.route') === 'next');
          }
        });
      });
      ...
      _.each(stackInstances, function(colorInstances, color) {
        ...
        _.each(colorInstances, function(instance, instanceId) {
          if (instance.Tags.ns.service === 'web') {
            ...
            promoteToMain  = 'assignFqdnToInstance --fqdn='+stack+'.'+domainName+' --instance-id='+instance.InstanceId;
            promoteToColor = 'assignFqdnToInstance --fqdn='+subdomain+'.'+domainName+' --instance-id='+instance.InstanceId;
