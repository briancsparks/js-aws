...
var jsIam               = ra.require('../iam/iam', __dirname);
var jsEc2;
...
ec2.runInstance = function(argv, context, callback) {
  ...
  return sg.__run([function(next) {
    ...
    return sg.__runll([function(next) {
      ...
      return jsIam.getInstanceProfile({role:[namespace, service, 'instance-role'].join('-')}, {}, function(err, arn) {
        if (err) {
          ...
          return jsIam.getInstanceProfile({role:[namespace, '', 'instance-role'].join('-')}, {}, function(err, arn) {
...
var waitForInstanceState = ec2.waitForInstanceState = function(argv, context, callback) {
  ...
  return sg.until(function(again, last, count, elapsed) {
    ...
    return jsEc2.isInstanceState(argv, context, function(err, isRunning, instances) {
 ...
 */
var isInstanceState = ec2.isInstanceState = function(argv, context, callback) {
  var log         = sg.mkLogger(argv);
  ...
  return jsEc2.getInstances(diParams, context, function(err, instances) {
...
var createAmi = ec2.createAmi = function(argv, context, callback) {
  ...
  return jsEc2.createImage(ciParams, {}, function(err, results) {
    ...
    return waitForImageState(_.extend({imageId:results.ImageId}, argv), context, function(err, images) {
...
var waitForImageState = ec2.waitForImageState = function(argv, context, callback) {
  ...
  if (argvGet(argv, 'no-wait') && argvGet(argv, 'no-wait-instance')) {
  ...
  return sg.until(function(again, last, count, elapsed) {
    ...
    return sg.__runll([function(next) {
      images = null;
      return getImages(diParams, {}, function(err, images_) {
      ...
      instances = null;
      isRunning = false;
      return jsEc2.isInstanceState(argv, context, function(err, isRunning_, instances_) {
        if (!err) {
