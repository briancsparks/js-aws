    ...
    return sg.__runll([function(next) {
        ...
        return fetch2('listRRSEz', raRoute53.listResourceRecordSetsEz, 'ResourceRecordSets', g, 'recordSets', params, context, callback, function() {
          ...
          g.recordSets.push({
            ...
            Type              : 'A',
            TTL               : 300,
            ResourceRecords   : [{ 'Value' : '54.83.104.186'}]
          });
          return next();
        });
...
//          if (current.ourInstances[instanceId].Tags[namespace].stack !== 'develop') { continue; }
...
// ap-northeast-1  trusty   14.04 LTS  amd64  hvm:ebs-ssd  20170629    ami-88091aef  hvm
// ap-northeast-1  xenial   16.04 LTS  amd64  hvm:ebs-ssd  20170619.1  ami-785c491f  hvm

amis.ap_northeast_1.precise  = 'ami-411b2d26';
amis.ap_northeast_1.trusty   = 'ami-88091aef';
amis.ap_northeast_1.xenial   = 'ami-785c491f';
...
// us-east-1  trusty   14.04 LTS  amd64  hvm:ebs-ssd  20170629    ami-810f3297  hvm
// us-east-1  xenial   16.04 LTS  amd64  hvm:ebs-ssd  20170619.1  ami-d15a75c7  hvm

amis.us_east_1.precise  = 'ami-a04529b6';
amis.us_east_1.trusty   = 'ami-810f3297';
amis.us_east_1.xenial   = 'ami-d15a75c7';
