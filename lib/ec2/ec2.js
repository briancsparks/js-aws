 ...
 *    argv.user_data
 */
libEc2.runInstance = function(argv, context, callback) {
  ...
  var ip, tier, service, serviceType, namespace, stack, launchConfig_, numTriesLeft, instanceName, octets, serviceNum, upNamespace;
  ...
  upNamespace       = namespace.toUpperCase();
  serviceNum        = 0;
    ...
    return sg.__runll([function(next) {
      ...
      return sg.__run([function(next) {
        ...
        function once() {
          ...
          launchConfig.UserData                   = getUserdata0(argvGet(argv, 'username,user') || 'scotty', upNamespace, buildoutEnvVars);
