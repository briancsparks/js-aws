...
libEc2.current = function(argv, context, callback) {
  ...
  return fetch(jsaws.envInfo, g, 'envInfo', argv, context, callback, function() {
    ...
    }, function(next) { return fetch(raVpc.get2Vpcs, g, 'vpcs', argv, context, callback, next);
    }, function(next) { return fetch(raEc2.get2Instances, g, 'instances', argv, context, callback, next);
